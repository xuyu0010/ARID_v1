...
class Res_I3D(nn.Module):
    ...
    def __init__(self,
	 ...
	 #TODO: Check whether pad=0 differs a lot
        ...
        self.cls_head = ClsHead(with_avg_pool=False, temporal_feature_size=1,
                                spatial_feature_size=1,dropout_ratio=0.5,
        ...
        if pretrained:
            pretrained_model=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'pretrained/i3d_kinetics_rgb_r50_c3d.pth')
